...
require_once '../../../../../../../Blog/app/code/community/SourceryWeb/Blog/controllers/recaptcha/recaptchalib-SourceryWeb.php';

class Blog_PostController extends Mage_Core_Controller_Front_Action
{
    ...
    {			
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			try 
			{
				...
				{
					$model->setStatus(1);
					Mage::getSingleton('customer/session')->addSuccess(Mage::helper('blog')->__('Your comment has been submitted and is SourceryWebaiting approval.'));
				}
				$model->save();
