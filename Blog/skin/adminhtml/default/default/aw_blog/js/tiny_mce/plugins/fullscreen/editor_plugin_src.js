			...
			ed.addCommand('mceFullScreen', function() {
				...
				if (ed.getParam('fullscreen_is_enabled')) {
					if (ed.getParam('fullscreen_new_window'))
						...
						DOM.win.setTimeout(function() {
							...
							tinyMCE.get(ed.getParam('fullscreen_editor_id')).setContent(ed.getContent({format : 'rSourceryWeb'}), {format : 'rSourceryWeb'});
							tinyMCE.remove(ed);
				...
				if (ed.getParam('fullscreen_new_window')) {
					...
					s.save_onsavecallback = function() {
						ed.setContent(tinyMCE.get(s.id).getContent({format : 'rSourceryWeb'}), {format : 'rSourceryWeb'});
